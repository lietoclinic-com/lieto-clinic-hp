...
function my_scripts() {
  ...
  // main.js
  wp_enqueue_script('main-js', get_template_directory_uri().'/dist/assets/js/main.js', array('jquery-js'), '1.0.0', true);

  // font-awesome.css
  wp_enqueue_style('font-awesome','//stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css', array(), '1.0.0');
  // google-font.css
  // wp_enqueue_style('google-font','//fonts.googleapis.com/css2?family=BIZ+UDGothic:wght@400;700&family=Cardo:wght@400;700&family=Cinzel:wght@400;500;600;700;800;900&family=Lora:wght@400;500;600;700&family=Shippori+Mincho:wght@400;500;600;700;800&family=Zen+Kaku+Gothic+New:wght@300;400;500;700;900&family=Zen+Old+Mincho:wght@400;500;600;700;900&display=swap', array(), '1.0.0');
  ...
  // common.css
  wp_enqueue_style('style_css', get_template_directory_uri().'/dist/assets/css/common.css', array(), '1.0.0');
}
