<div class="p-cta">
  <div class="p-cta__bg">
    ...
    <div class="p-cta__top">
      <img loading="lazy" src='<?php echo esc_url(get_template_directory_uri()); ?>/dist/img/icon/icon_alltime.png'>
      <div class="p-cta__reserve">
        ...
        <div class="p-cta__reserveBtn _overTab">
          <a href="https://ac.lietoclinic.com/cl/043cbe9C3Ge4cC56/?bid=1fC589b7e76c3p4p">
            <img loading="lazy" src='<?php echo esc_url(get_template_directory_uri()); ?>/dist/img/icon/icon_counseling_circle.png'>
            無料カウンセリング予約
          </a>
        </div>
      </div>
        ...
        <a href="tel:<?php echo get_field('toll-free', 94); ?>">
          ...
          <div class="p-cta__clinicInfo">
            <div class="p-cta__clinicTel">
              <img loading="lazy" src='<?php echo esc_url(get_template_directory_uri()); ?>/dist/img/icon/icon_tel.png'>
