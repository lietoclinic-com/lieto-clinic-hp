                ...
                <ul class="p-clatuuFeature__list">
                  ...
                  <li class="p-clatuuFeature__item _first">
                    ...
                    <div class="p-clatuuFeature__itemBody">
                      ...
                      <h4 class="c-listBox__title" style="margin-top: 40px; padding-bottom: 1rem;">脂肪燃焼のメカニズム</h4>
                      <figure class="p-clatuuFeature__itemFigure" style="max-width: 640px; margin: 40px auto 0;">
                        <picture>
                          <img src="<?php echo esc_url(get_template_directory_uri()); ?>/dist/img/menu/upper-arm_point4.webp" alt="女性の脂肪のつき方は年齢でこんなに変わる" loading="lazy">
                        </picture>
                      </figure>
                      <div class="p-content">
                        <ol>
                          <li>運動などでエネルギーが必要になる</li>
                          <li>脳が脂肪分解の指令を出す</li>
                          <li>全身の脂肪が血液中に分解される</li>
                          <li>分解された脂肪酸が筋肉でエネルギーとして消費される</li>
                        </ol>
                      </div>
                ...
                <li class="p-clatuuCase__item">
                  ...
                  <div class="p-clatuuCase__figures">
                    <figure class="p-clatuuCase__figure">
                      ...
                      <img src="<?php echo esc_url(get_template_directory_uri()); ?>/dist/img/menu/slim-thighs-case01-before.webp" alt="【20代 女性】" decoding="async" loading="lazy">
                      <figcaption>術前</figcaption>
                    </figure>
                    <figure class="p-clatuuCase__figure">
                      <img src="<?php echo esc_url(get_template_directory_uri()); ?>/dist/img/menu/slim-thighs-case01-after.webp" alt="【20代 女性】" decoding="async" loading="lazy">
                  ...
                  <p class="is-caution">※太もものサイズは右太ももの前後で比較</p>
                ...
                <li class="p-clatuuCase__item">
                  ...
                  <div class="p-clatuuCase__figures">
                    <figure class="p-clatuuCase__figure">
                      ...
                      <img src="<?php echo esc_url(get_template_directory_uri()); ?>/dist/img/menu/slim-thighs-case02-before.webp" alt="【30代 女性】" decoding="async" loading="lazy">
                      <figcaption>術前</figcaption>
                    </figure>
                    <figure class="p-clatuuCase__figure">
                      <img src="<?php echo esc_url(get_template_directory_uri()); ?>/dist/img/menu/slim-thighs-case02-after.webp" alt="【30代 女性】" decoding="async" loading="lazy">
                ...
                <li class="p-clatuuCase__item">
                  ...
                  <div class="p-clatuuCase__figures">
                    <figure class="p-clatuuCase__figure">
                      ...
                      <img src="<?php echo esc_url(get_template_directory_uri()); ?>/dist/img/menu/slim-thighs-case03-before.webp" alt="【20代 女性】" decoding="async" loading="lazy">
                      <figcaption>術前</figcaption>
                    </figure>
                    <figure class="p-clatuuCase__figure">
                      <img src="<?php echo esc_url(get_template_directory_uri()); ?>/dist/img/menu/slim-thighs-case03-after.webp" alt="【20代 女性】" decoding="async" loading="lazy">
                      <figcaption>術後約5ヶ月</figcaption>
                    </figure>
                  </div>
                  <table>
                ...
                <li class="p-clatuuCase__item">
                  ...
                  <div class="p-clatuuCase__figures">
                    <figure class="p-clatuuCase__figure">
                      ...
                      <img src="<?php echo esc_url(get_template_directory_uri()); ?>/dist/img/menu/slim-thighs-case04-before.webp" alt="【40代 女性】" decoding="async" loading="lazy">
                      <figcaption>術前</figcaption>
                    </figure>
                    <figure class="p-clatuuCase__figure">
                      <img src="<?php echo esc_url(get_template_directory_uri()); ?>/dist/img/menu/slim-thighs-case04-after.webp" alt="【40代 女性】" decoding="async" loading="lazy">
