    ...
    <div class="p-message__inner l-inner">
      <div class="p-message__body">
        <figure class="p-message__figure">
          <img loading="lazy" src="<?php echo esc_url(get_template_directory_uri()); ?>/dist/img/common/doctor.png" alt="リエートクリニック 院長 松永 宏之">
      ...
      <div class="p-message__btn">
        <a href="/greeting/" class="c-btn">院長について詳しくみる</a>
      </div>
    </div>
  </section>
