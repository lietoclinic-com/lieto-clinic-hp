    ...
    <div class="p-pageMessage__body">
      ...
      <section class="p-pageMessageGreeting">
        <div class="p-pageMessageGreeting__inner l-inner">
          ...
          <div class="p-singleMenu__box"></div>
          <div class="p-singleMenu__box">
            <div class="p-singleMenu__flex">
                ...
                <div class="p-singleRecruitInfo__body">
                  <div class="p-singleRecruitInfo__list">
                    <div class="p-singleRecruitInfo__row">
                      <dt>1992年</dt>
                      <dd><a href="https://www.aichi-med-u.ac.jp/" target="_blank">愛知医科大学</a> 卒業</dd>
                    </div>
                    <div class="p-singleRecruitInfo__row">
                      <dt>1992年</dt>
                      <dd><a href="https://www.aichi-med-u.ac.jp/hospital/" target="_blank">愛知医科大学付属病院</a> 第二外科医局 入局 </dd>
                    </div>
                    <div class="p-singleRecruitInfo__row">
                      <dt>1993年</dt>
                      <dd><a href="http://www.tsushimacity-hp.jp/" target="_blank">津島市民病院</a> 外科</dd>
                    </div>
                    <div class="p-singleRecruitInfo__row">
                      <dt>2003年</dt>
                      <dd>同病院 外科医長</dd>
                    ...
                    <div class="p-singleRecruitInfo__row">
                      ...
                      <dd>
                        同病院 救急医療部長
                        <br><a href="https://www.icls-web.com/articles/fwq1lsu-6x93" target="_blank">ICLS.JATEC.JPTEC.MCLSインストラクター</a>
                    ...
                    <div class="p-singleRecruitInfo__row">
                      <dt>2024年</dt>
                      <dd>リエートクリニック名古屋院 院長就任<br>理事長就任</dd>
                    </div>
                  </div>
                </div>
              ...
              <div class="p-singleMenu__flexDesc">
                <div class="p-pageMinorAge__head p-pageMinorHead" style="margin-top: 48px;">
                  <h3 class="p-pageMinorHead__title">資格</h3>
                </div>
                <div class="p-singleRecruitInfo__body">
                  <div class="p-singleRecruitInfo__list">
                    <div class="p-singleRecruitInfo__row">
                    ...
                    <div class="p-singleRecruitInfo__row">
                      <dt>2002年</dt>
                      <dd><a href="https://jp.jssoc.or.jp/" target="_blank">日本外科学会</a>外科専門医取得</dd>
                    </div>
                    <div class="p-singleRecruitInfo__row">
                      <dt>2015年</dt>
