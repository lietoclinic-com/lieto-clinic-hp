  ...
  <section class="p-singleMenu">
    ...
    <div class="p-singleMenu__body">
          ...
          <div class="p-singleMenu__flex">
            ...
            <div class="p-singleMenu__desc">
              <ul class="p-singleMenu__list">
                <li class="p-singleMenu__item">激しいトレーニングは向いていない</li>
                <li class="p-singleMenu__item">部分痩せを実現したい</li>
                <li class="p-singleMenu__item">効果的なトレーニングを求めている</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div class="p-singleMenu__area l-inner">
        ...
        <div class="p-singleMenu__box">
          <ul class="p-singleMenu__boxCase p-case">
      ...
      <div class="p-singleMenu__area l-inner">
        ...
        <div class="p-singleMenu__box">
          <dl class="p-singleMenu__boxList">
            <div class="p-singleMenu__boxRow">
              <dt>施術時間</dt>
              <dd>20分〜60分程</dd>
            </div>
            <div class="p-singleMenu__boxRow">
              ...
              <div class="p-faq__question">
                <div class="p-faq__questionDesc">
                  ...
                  <span class="p-faq__questionText" itemprop="name">
                    こちらに質問が入ります。こちらに質問が入ります。こちらに質問が入ります。こちらに質問が入ります。こちらに質問が入ります。こちらに質問が入ります。こちらに質問が入ります。
                  </span>
                </div>
              ...
              <div class="p-faq__answer" itemprop="acceptedAnswer" itemscope itemtype="https://schema.org/Answer">
                <div class="p-faq__answerDesc">
                  ...
                  <span class="p-faq__answerText" itemprop="text">
                    こちらに回答が入ります。こちらに回答が入ります。こちらに回答が入ります。こちらに回答が入ります。こちらに回答が入ります。こちらに回答が入ります。こちらに回答が入ります。こちらに回答が入ります。こちらに回答が入ります。こちらに回答が入ります。こちらに回答が入ります。
                  </span>
                </div>
              </div>
            </div>
            ...
            <div class="p-faq__box js-faqAccordion" itemprop="mainEntity" itemscope itemtype="https://schema.org/Question">
              ...
              <div class="p-faq__question">
                <div class="p-faq__questionDesc">
                  <div class="p-faq__questionMark">Q</div>
                  <span class="p-faq__questionText" itemprop="name">
                    こちらに質問が入ります。こちらに質問が入ります。こちらに質問が入ります。
                  </span>
                </div>
                <span class="p-faq__questionOpen"></span>
              </div>
              ...
              <div class="p-faq__answer" itemprop="acceptedAnswer" itemscope itemtype="https://schema.org/Answer">
                <div class="p-faq__answerDesc">
                  <div class="p-faq__answerMark">A</div>
                  <span class="p-faq__answerText" itemprop="text">
                    こちらに回答が入ります。こちらに回答が入ります。こちらに回答が入ります。
                  </span>
                </div>
              </div>
            </div>
